        ...
        placeGroups: [
          {
            heading: "Nearby attractions",
            places: [
              { name: "2nd Street District", time: "3 min" },
              { name: "6th Street Entertainment District", time: "4 min" },
              { name: "Congress Avenue Bridge (bat colony at dusk)", time: "4 min" },
              { name: "Ann and Roy Butler Trail, Lady Bird Lake", time: "5 min" },
              { name: "Texas State Capitol", time: "6 min" },
              { name: "Rainey Street Historic District", time: "7 min" },
              { name: "Moody Center", time: "8 min" },
              { name: "Blanton Museum of Art", time: "8 min" },
              { name: "South Congress Avenue (SoCo)", time: "9 min" },
              { name: "Zilker Park", time: "11 min" },
              { name: "Barton Springs Pool", time: "12 min" },
              { name: "Mount Bonnell", time: "17 min" },
            ],
          },
          {
            heading: "Nearby dining",
            places: [
              { name: "Cooper's Old Time Pit Bar-B-Que", time: "3 min" },
              { name: "Salt Traders Coastal Cooking", time: "4 min" },
              { name: "Moonshine Patio Bar & Grill", time: "5 min" },
              { name: "Iron Works BBQ", time: "6 min" },
              { name: "Torchy's Tacos", time: "6 min" },
              { name: "Terry Black's Barbecue", time: "8 min" },
              { name: "Veracruz All Natural", time: "8 min" },
              { name: "Uchi", time: "9 min" },
              { name: "La Barbecue", time: "9 min" },
              { name: "Franklin Barbecue", time: "9 min" },
            ],
          },
          {
            heading: "Nearby shopping & activities",
            places: [
              { name: "Whole Foods Market (flagship store)", time: "4 min" },
              { name: "Waterloo Records", time: "5 min" },
              { name: "Rowing Dock (kayak and paddleboard hire)", time: "8 min" },
              { name: "South Congress Avenue shops", time: "9 min" },
              { name: "Peter Pan Mini Golf", time: "9 min" },
              { name: "Barton Creek Square", time: "16 min" },
              { name: "The Domain", time: "20 min" },
            ],
          },
        ],
        eventFlag: {
